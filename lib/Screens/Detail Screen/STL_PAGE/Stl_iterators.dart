...
class Stl_Iterators extends StatelessWidget {
  ...
  final introText = new RichText(
        text: TextSpan(
          ...
          new TextSpan(
              text: "They are used only with single pass algorithms i.e. they can move to all the locations in a range atmost once. They are used to "
              ),
          new TextSpan(
              text:"read ",
          ...
          new TextSpan(
            text:"the value pointed by the iterator , inorder to retrieve or "
          ),
          new TextSpan(
              text:"access ",
              style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red),
          ...
          new TextSpan(
            text: "it using * or -> operator but neither we can assign value nor modify it through this iterator. Operators which can be used for input iterator are increment operator(++), decrement operator(--), dereference operator(*), not equal operator(!=) and equal operator(==).\n\n"
          ...
          new TextSpan(
              text: "They are used only with single pass algorithms i.e. they can move to all the locations in a range atmost once. As they are complementary or exact opposite of Input iterators, they are used to "
              ),
          new TextSpan(
              text:"write ",
              style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red),
          ...
          new TextSpan(
            text: "it using * or -> operator but this does not allow us to read the value pointed by the iterator. Operators which can be used for output iterator are increment operator(++), decrement operator(--) and assignment operator(=).\n\n"
          ...
          new TextSpan(
              text: "They are combination of both input and output iterators. It allow us to both "
                 ),
          ...
          new TextSpan(
            text:"to the elements of the container. As their name suggests, they can only move in "
          ),
          new TextSpan(
            text: "forward ",
            style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red),
          ...
          new TextSpan(
            text:"direction , i.e.  why they can only use increment operator(++). This can be "
          ),
          new TextSpan(
            text:"dereferenced ",
            style: TextStyle(fontWeight: FontWeight.bold, color: Colors.red),
          ...
          new TextSpan(
            text:"and due to this we can both access and assign the values to the container.\n\n"
          ),
        ...
        new TextSpan(
          ...
          new TextSpan(
            text:"Containers in which they are used :-\n"
          ),
          new TextSpan(
          ...
          new TextSpan(
            text:" iterators in terms of functionality. As their name suggests, they can be used to access the element at any arbitary offset position. It has all the featuresof bidirectional operators, besides this random access operator provide us one more feature i.e.  Pointer addition and pointer subtraction.\n"
          ),
