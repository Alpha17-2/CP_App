...
class hardjava extends StatefulWidget {
  @override
  _hardjavaState createState() => _hardjavaState();
}

class _hardjavaState extends State<hardjava> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<j3>(context, listen: true).ListOfJavaquestions;
