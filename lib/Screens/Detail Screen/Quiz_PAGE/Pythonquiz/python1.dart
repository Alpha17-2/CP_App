...
class easypython extends StatefulWidget {
  @override
  _easypythonState createState() => _easypythonState();
}

class _easypythonState extends State<easypython> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<p1>(context, listen: true).ListOfpythonquestions;
