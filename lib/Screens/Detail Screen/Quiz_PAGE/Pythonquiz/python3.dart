...
class hardpython extends StatefulWidget {
  @override
  _hardpythonState createState() => _hardpythonState();
}

class _hardpythonState extends State<hardpython> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<p3>(context, listen: true).ListOfpythonquestions;
