...
import 'package:CP_App/Providers/Quiz/QueueQuizList.dart';

class Queue_Quiz extends StatefulWidget {
  @override
  _Queue_QuizState createState() => _Queue_QuizState();
}

class _Queue_QuizState extends State<Queue_Quiz> {
  @override
  int i = 0;
  int correctanswer = 0;
  ...
  Widget build(BuildContext context) {
    final mylist =
        Provider.of<QueueQuizlist>(context, listen: true).ListOfQueuequestions;
