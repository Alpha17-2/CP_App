...
class easyqueue extends StatefulWidget {
  @override
  _easyqueueState createState() => _easyqueueState();
}

class _easyqueueState extends State<easyqueue> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<q1>(context, listen: true).ListOfQueuequestions;
