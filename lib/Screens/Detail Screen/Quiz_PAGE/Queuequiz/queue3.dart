...
class hardqueue extends StatefulWidget {
  @override
  _hardqueueState createState() => _hardqueueState();
}

class _hardqueueState extends State<hardqueue> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<q3>(context, listen: true).ListOfQueuequestions;
