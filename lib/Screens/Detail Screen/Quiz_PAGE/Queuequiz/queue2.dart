...
class mediumqueue extends StatefulWidget {
  @override
  _mediumqueueState createState() => _mediumqueueState();
}

class _mediumqueueState extends State<mediumqueue> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<q2>(context, listen: true).ListOfQueuequestions;
