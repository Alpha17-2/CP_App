...
class hardarray extends StatefulWidget {
  @override
  _hardarrayState createState() => _hardarrayState();
}

class _hardarrayState extends State<hardarray> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<ar3>(context, listen: true).ListOfArrayquestions;
