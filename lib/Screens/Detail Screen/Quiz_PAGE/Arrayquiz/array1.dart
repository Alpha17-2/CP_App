...
class easyarray extends StatefulWidget {
  @override
  _easyarrayState createState() => _easyarrayState();
}

class _easyarrayState extends State<easyarray> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<ar1>(context, listen: true).ListOfArrayquestions;
