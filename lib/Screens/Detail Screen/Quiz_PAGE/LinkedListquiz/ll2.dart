...
class mediumlinkedlist extends StatefulWidget {
  @override
  _mediumlinkedlistState createState() => _mediumlinkedlistState();
}

class _mediumlinkedlistState extends State<mediumlinkedlist> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist =
        Provider.of<ll2>(context, listen: true).ListOfLinkedListquestions;
