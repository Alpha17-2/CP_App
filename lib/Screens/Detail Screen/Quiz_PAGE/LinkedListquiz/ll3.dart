...
class hardlinkedlist extends StatefulWidget {
  @override
  _hardlinkedlistState createState() => _hardlinkedlistState();
}

class _hardlinkedlistState extends State<hardlinkedlist> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
