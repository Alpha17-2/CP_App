...
class easylinkedlist extends StatefulWidget {
  @override
  _easylinkedlistState createState() => _easylinkedlistState();
}

class _easylinkedlistState extends State<easylinkedlist> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist =
        Provider.of<ll1>(context, listen: true).ListOfLinkedListquestions;
