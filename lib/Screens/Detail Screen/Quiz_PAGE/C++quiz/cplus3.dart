...
class hardcplus extends StatefulWidget {
  @override
  _hardcplusState createState() => _hardcplusState();
}

class _hardcplusState extends State<hardcplus> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<cplus3>(context).ListOfCplusquestions;
