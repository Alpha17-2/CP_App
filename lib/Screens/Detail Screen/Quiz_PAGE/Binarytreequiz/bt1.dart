...
class easybt extends StatefulWidget {
  @override
  _easybtState createState() => _easybtState();
}

class _easybtState extends State<easybt> {
  @override
  int i = 0;
  int correctanswer = 0;
  int attempts = 0;
  ...
  Widget build(BuildContext context) {
    final mylist =
        Provider.of<t1>(context, listen: true).ListOfBinarytreequestions;
