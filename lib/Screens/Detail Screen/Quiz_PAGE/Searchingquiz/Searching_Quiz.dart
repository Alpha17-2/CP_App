...
class Searching_Quiz extends StatefulWidget {
  @override
  _Searching_QuizState createState() => _Searching_QuizState();
}

class _Searching_QuizState extends State<Searching_Quiz> {
  @override
  int i = 0;
  int correctanswer = 0;
  ...
  Widget build(BuildContext context) {
    final mylist = Provider.of<SearchingQuizlist>(context, listen: true)
        .ListOfSearchingquestions;
