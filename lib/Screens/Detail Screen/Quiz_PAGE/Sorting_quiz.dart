...
import 'package:CP_App/Providers/Quiz/SrtQuixlist.dart';

class Sorting_Quiz extends StatefulWidget {
  @override
  _Sorting_QuizState createState() => _Sorting_QuizState();
}

class _Sorting_QuizState extends State<Sorting_Quiz> {
  @override
  int i = 0;
  int correctanswer = 0;
  ...
  Widget build(BuildContext context) {
    final mylist =
        Provider.of<SortQuizlist>(context, listen: true).ListOfSortingquestions;
