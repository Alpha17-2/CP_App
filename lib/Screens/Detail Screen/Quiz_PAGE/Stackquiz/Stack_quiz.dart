...
import 'package:CP_App/Providers/Quiz/StackQuizList.dart';

class Stack_Quiz extends StatefulWidget {
  @override
  _Stack_QuizState createState() => _Stack_QuizState();
}

class _Stack_QuizState extends State<Stack_Quiz> {
  @override
  int i = 0;
  int correctanswer = 0;
  ...
  Widget build(BuildContext context) {
    final mylist =
        Provider.of<StackQuizlist>(context, listen: true).ListOfStackquestions;
