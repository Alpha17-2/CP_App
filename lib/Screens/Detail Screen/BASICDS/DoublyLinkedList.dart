        ...
        body: Padding(
            ...
            child: SingleChildScrollView(
              ...
              children: [
                ...
                Text(
                    "2. Now make the prev of this new head node point to NULL. ",
                    style: TextStyle(
                      fontSize: fontsize,
                    )),
                Opacity(
                ...
                Text(
                    "1. Traverse the list, to reach the last node of the list.",
                    style: TextStyle(fontSize: fontsize)),
                Opacity(
                    opacity: 0.0,
                    child: Divider(
                ...
                Text(
                    "2. Traverse the list until we find the desired data value.",
                    style: TextStyle(fontSize: fontsize)),
                Opacity(
                    opacity: 0.0,
                    child: Divider(
