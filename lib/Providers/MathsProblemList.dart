...
class MathsProblem extends ChangeNotifier {
  List<SingleProblem> MathsProb = [
    SingleProblem(
      ...
      inputFormat: "The First line contains integers n(number of apartments) and x(apartment on each floor except the first one)",
    ...
    SingleProblem(
      ...
      inputFormat: "First line contains two separated integers N and M",
    ...
    SingleProblem(
      ...
      constraints: "1≤L,R≤10^7",
      inputFormat: "First line contains two space separated integers L and R",
    ),
    SingleProblem(
