...
class CplusQuizlist extends ChangeNotifier {
  ...
  SingleQuizQuestion(
    question: "A language which has the capability to generate new data types are called ?",
      option1: "Extensible",
      option2: "Overloaded",
  ...
  SingleQuizQuestion(
    question: "If a class contains pure virtual function, then it is termed as____.?",
