...
class ArrayProblems extends ChangeNotifier {
  List<SingleProblem> ArrayProb = [
    ...
    SingleProblem(
     ...
     inputExplain:"After sorting, the array becomes 1 3 3 4 5 6. here the largest subarray where absolute difference between consecutive element is less tha or equal to 1 is( 4 5 6).The length of this subarray is 3",
     constraints:"2<n<100\n0<a[i]<100",
     tags:"null",
  ...
  SingleProblem(
    ...
    input:"4 10\n7 2 3 9",
    output:"3",
    inputExplain:" Here sum of 2 and 7 will be less than 10.That means,we have to assign one gandola to them.Now the remaining gandolas are 3 and 9 and therir sum exceed 10 i.e. why we can't assign one gandola to them.we have to assign them two different gandolas.so here we require total 3 gandolas.",
  ...
  SingleProblem(
     ...
     input:"8\n-1 3 -2 5 3 -5 2 2",
     output:"9",
     inputExplain:"Here we have taken subarray from index 1 to index 4 i.e.(3 -2 5 3) this is the subarray which contains the largest sum i.e. 9 ",
     constraints:"1≤n≤2⋅10^5 \n−10^9≤xi≤10^9",
  ...
  SingleProblem(
    ...
    input:"4 8\n2 7 5 1",
    output:"2 4",
    description:" we can add 7 and 1 to get sum 8 in this case .The index of 7 and 1 is 2 and 4 respectively ",
