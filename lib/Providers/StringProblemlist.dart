...
class StringProblems extends ChangeNotifier {
  List<SingleProblem> StringProb = [
    ...
    SingleProblem(
      ...
      input: "ATTCGGGA",
      output: "3",
      description: "You are given with a DNA sequence: a string consisting of characters A, C, G, and T. Your job is to find the longest repitition in the sequence.This is a maximum-length substring containing only one type of character.",
      inputExplain: "null",
      constraints: "1≤n≤10^6",
      tags: "null",
      prereq: "null",
    ...
    SingleProblem(
      ...
      input: "aaabbb \nxaxbbbxx",
      output: "3\n1",
      description: "Two words are said to be anagrams of one another if their letters can be rearranged to form the other word.\nHere, you are provided with a string.You must split it into two contiguous substring, then determine the minimum number of characters to change to make the two substrings into anagrams ofone another.",
      inputExplain: "In the first input statement we split s into two strings s1='aaa' and s2='bbb'.We have replace all three characters from the first string with 'b' to make the strings anagrams.\nIn the second input s1='xaxb' and s2='bbxx'. you must replace 'a' from s1 with 'b' so that s1='xbxb'.",
      constraints: "1≤q≤100 \n 1≤|s|≤10^4",
      tags: "null",
      prereq: "null",
      explaination: "null",
    ...
    SingleProblem(
      ...
      inputExplain: "In the first input you have to delete the third and forth character from string in order to turn 010011 to 0111.",
      constraints: "1≤|s|≤100",
      tags: "null",
      prereq: "null",
      explaination: "null",
      code: "null",
      inputFormat: "The input will contain a string s, where the each characters of s should be either 0 or 1.",
    ),
    SingleProblem(
      title: "Dotted String",
      difficulty: "Easy",
      input: "Success",
      output: ".s.c.c.s.s",
      description: "You are provided by a string .Your job is to frame acode that should perform these tasks.\n1. Delete all the vowels.\n2. Insert a character '.' before each consonants.\n3. Replace all uppercase consonants with its corresponding lowercase ones.",
      inputExplain: "In the word 'Success' there are two vowels i.e. u and e ,so we removed the two vowels.Next we have to add '.' before all the characters left which we did for Success.Lastly as per the question says we replaced 'S' which is in uppercase to its lowercase 's'. ",
      constraints: "null",
      tags: "null",
      prereq: "null",
      explaination: "null",
      code: "null",
      inputFormat: "The input will contain a string s.It should only consists of uppercase and lowercase latin letters and its lenght is from 1 to 100.",
    ),
    SingleProblem(
      title: "Substring",
      difficulty: "Easy",
